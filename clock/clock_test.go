...
//
// While the time.Clock type in the standard library (https://golang.org/pkg/time/#Time)
...
// than pointers. Note also how most time.Clock methods have value receivers
